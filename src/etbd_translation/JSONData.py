...
class JSONData(object):
    ...
    def get_sd(self, experiment_index = 0):
        return self.get_from_experiment(JSONData._SD, experiment_index, JSONData._DEFAULT_SD)

    def get_from_experiment(self, key, experiment_index = 0, default = None):
        default = self.get(key, default)
        return self.get_experiment(experiment_index).get(key, default)

    def get(self, key, default = None):
        return self.data_dict.get(key, default)

    def get_experiment(self, experiment_index = 0):
        return self.data_dict[JSONData._EXPERIMENTS][experiment_index]

    def get_sched_type_1(self, experiment_index = 0):
    ...
    def get_single_punishment_ri(self, experiment_index = 0):
        return self.get_from_experiment(JSONData._SINGLE_PUNISHMENT_RI, experiment_index, JSONData._DEFAULT_SINGLE_PUNISHMENT_RI)

    def get_sched_value_1(self, experiment_index = 0):
        return self.get_from_experiment(JSONData._SCHED_VALUE_1, experiment_index, JSONData._DEFAULT_SCHED_VALUE)

    def get_sched_value_2(self, experiment_index = 0):
        return self.get_from_experiment(JSONData._SCHED_VALUE_2, experiment_index, JSONData._DEFAULT_SCHED_VALUE)

    def get_output_path(self, experiment_index = 0):
        return self.get_from_experiment(JSONData._OUTPUT_PATH, experiment_index, JSONData._DEFAULT_OUTPUT_PATH)

    def get_file_stub(self, experiment_index = 0):
        return self.get_from_experiment(JSONData._FILE_STUB, experiment_index, JSONData._DEFAULT_FILE_STUB)

    def get_generations(self, experiment_index = 0):
        return self.get_from_experiment(JSONData._GENERATIONS, experiment_index, JSONData._DEFAULT_GENERATIONS)

    def get_repetitions(self, experiment_index = 0):
        return self.get_from_experiment(JSONData._REPETITIONS, experiment_index, JSONData._DEFAULT_REPETITIONS)

    def check_is_punishment_ok(self, experiment_index = 0):
        return self.get_from_experiment(JSONData._CHECK_IS_PUNISHMENT_OK, experiment_index, JSONData._DEFAULT_CHECK_IS_PUNISHMENT_OK)

    def use_gray_codes(self, experiment_index = 0):
        return self.get_from_experiment(JSONData._USE_GRAY_CODES, experiment_index, JSONData._DEFAULT_USE_GRAY_CODES)

    def get_decay_of_transfer(self, experiment_index = 0):
        return self.get_from_experiment(JSONData._DECAY_OF_TRANSFER, experiment_index, JSONData._DEFAULT_DECAY_OF_TRANSFER)

    def get_fomo_a(self, experiment_index = 0):
        return self.get_from_experiment(JSONData._FOMO_A, experiment_index, JSONData._DEFAULT_FOMO_A)

    def add_viscosity(self, experiment_index = 0):
        return self.get_from_experiment(JSONData._ADD_VISCOSITY, experiment_index, JSONData._DEFAULT_ADD_VISCOSITY)

    def get_viscosity_ticks(self, experiment_index = 0):
        return self.get_from_experiment(JSONData._VISCOSITY_TICKS, experiment_index, JSONData._DEFAULT_VISCOSITY_TICKS)

    def get_viscosity_selected_index(self, experiment_index = 0):
    ...
    def get_fitness_landscape(self, experiment_index = 0):
    ...
    def get_punishment_method(self, experiment_index = 0):
    ...
    def get_continuous_function_form(self, experiment_index = 0):
    ...
    def get_matchmaking_method(self, experiment_index = 0):
    ...
    def get_mutation_method(self, experiment_index = 0):

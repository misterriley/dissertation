    ...
    def add_experiments(self, json_data):
        ...
        for exp_index in range(0, self.m_intExpNum):
            ...
            for schedule_index in range(json_data.get_num_schedules(exp_index)):
                self.m_structExpInfo[exp_index].set_mag_1(json_data.get_mag_1(exp_index, schedule_index))
                self.m_structExpInfo[exp_index].set_mag_2(json_data.get_mag_2(exp_index, schedule_index))
                self.m_structExpInfo[exp_index].set_sched_values_1(json_data.get_sched_value_1(exp_index, schedule_index))
                self.m_structExpInfo[exp_index].set_sched_values_2(json_data.get_sched_value_2(exp_index, schedule_index))
